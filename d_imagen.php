...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
    <head>
        <meta charset="utf-8" />
        <title>Diseño de Imagen - Manoel Borja</title>
                        ...
                        <ul class="nav nav-pills nav-main scroll-menu" id="topMain">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="d_imagen.php">Diseño de imagen</a></li>
        ...
        <div id="middle" class="container">
            <div class="white">
                ...
                <header class="page-header">
                    <h1><strong>Diseño de Imagen</strong></h1>
                </header>
                ...
                <section id="portfolio">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-7">
                            <div class="owl-carousel controlls-over product-image" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/13.jpg">
                                </div>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/14.jpg">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3"><!-- item -->
                            <div class="item-box">
                                <figure>
                                    <a class="item-hover" href="tinturista.php">
                                        <span class="overlay"></span>
                                        <span class="inner">
                                            <strong>VER</strong> MÁS
                                        </span>
                                    </a>
                                    <img class="img-responsive" src="assets/images/demo/portfolio/3.jpg" width="260" height="260" alt="">
                                </figure>
                        ...
                        <div class="col-md-3"><!-- item -->
                            <div class="item-box">
                                <figure>
                                    <a class="item-hover" href="especialidades.php">
                                        <span class="overlay"></span>
                                        <span class="inner">
                                            <strong>VER</strong> MÁS
                                        </span>
                                    </a>
                                    <img class="img-responsive" src="assets/images/demo/portfolio/16.jpg" width="260" height="260" alt="">
                                </figure>
                                <div class="item-box-desc">
                        ...
                        <div class="col-md-3"><!-- item -->
                            <div class="item-box">
                                <figure>
                                    ...
                                    <img class="img-responsive" src="assets/images/demo/portfolio/8.jpg" width="260" height="260" alt="">
                                </figure>
                                <div class="item-box-desc">
                                    <h4>Manicurista</h4>
                                </div>
                        ...
                        <div class="col-md-3"><!-- item -->
                            <div class="item-box">
                                <figure>
                                    ...
                                    <img class="img-responsive" src="assets/images/demo/portfolio/12.jpg" width="260" height="260" alt="">
                                </figure>
                                <div class="item-box-desc">
                                    <h4>Maquillista</h4>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center">
                            <a href="https://www.facebook.com/pages/Manoel-Borja/538293596214655?fref=ts" class="socialbtn facebook"><i class="fa fa-facebook"></i>Facebook</a>
