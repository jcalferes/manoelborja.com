...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
    <head>
        <meta charset="utf-8" />
        <title>Especialidades - Manoel Borja</title>
        ...
        <div id="middle" class="container">
            <div class="white">
                ...
                <header class="page-header">
                    <h1><strong>Especialidades</strong></h1>
                </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-7">
                            <div class="owl-carousel controlls-over product-image" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/15.jpg">
                                </div>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/16.jpg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-5">
                            <ul class="list-icon star-o">
                                ...
                                <li>Depilado.</li>
                                <li>Tratamiento facial y capilar.</li>
                                <li>Masaje.</li>
                                <li>Spa.</li>
                                <li>Reafirmación de busto.</li>
                        ...
                        <div class="col-md-3"><!-- item -->
                            <div class="item-box">
                                <figure>
                                    ...
                                    <img class="img-responsive" src="assets/images/demo/portfolio/15.jpg" width="260" height="260" alt="">
                                </figure>
