...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
    <head>
        <meta charset="utf-8" />
        <title>Peinadora - Manoel Borja</title>
                        ...
                        <ul class="nav nav-pills nav-main scroll-menu" id="topMain">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="peinadora.php">Peinadora</a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-7">
                            <div class="owl-carousel controlls-over product-image" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/7.jpg">
                                </div>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/10.jpg">
                                </div>
                            </div>
                        </div>
