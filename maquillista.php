...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
    <head>
        <meta charset="utf-8" />
        <title>Maquillista - Manoel Borja</title>
                        ...
                        <ul class="nav nav-pills nav-main scroll-menu" id="topMain">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="maquillista.php">Maquillista</a></li>
        ...
        <div id="middle" class="container">
            <div class="white">
                ...
                <header class="page-header">
                    <h1><strong>Maquillista</strong></h1>
                </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-7">
                            <div class="owl-carousel controlls-over product-image" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/11.jpg">
                                </div>
                                <div>
                                    <img alt="" class="img-responsive" src="assets/images/demo/portfolio/12.jpg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3"><!-- item -->
                            <div class="item-box">
                                <figure>
                                    ...
                                    <img class="img-responsive" src="assets/images/demo/portfolio/14.jpg" width="260" height="260" alt="">
                                </figure>
